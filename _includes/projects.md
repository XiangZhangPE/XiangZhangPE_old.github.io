...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title">Discrete Symmetrical Coupled Inductor Structure and its Matrix-type Imple-mentation for DC-DC Converter</div>
    <div class="author"><strong>Xiang Zhang, Shangzhi Pan, Praveen Jain</strong></div>
    <div class="periodical"><em>2023 IEEE Energy Conversion Congress and Exposition, Nashville, TN <strong>(ECCE2023)</strong>, Nov. 2023.</em></div>
    <div class="links">
      <a href="assets/files/KTensors.bib" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">PDF</a>
      <a href="assets/files/KTensors.bib" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">BibTeX</a>
    </div>
  </div>
</div>
